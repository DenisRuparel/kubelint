...
// ValidateIngress checks for common best practices in Ingress manifests
...
// ValidateIngressBytes is a helper for validating Ingress content from byte slices (e.g. rendered YAML)

func ValidateIngressBytes(content []byte) []ValidationResult{
	var results []ValidationResult

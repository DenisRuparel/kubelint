...
// ValidateDeployment checks for common best practices in Deployment manifests
...
// ValidateDeploymentBytes is a variant of ValidateDeployment that operates on raw YAML content instead of file paths. This is useful for scanning rendered manifests in-memory without needing to read from disk.

func ValidateDeploymentBytes(content []byte) []ValidationResult {
	var results []ValidationResult
